...
class NeoPixelBackground(  # pylint: disable=too-few-public-methods
    ...
    def __init__(
        self, pin, n, *, bpp=3, brightness=0.1, auto_write=True, pixel_order=None
    ):
        if not pixel_order:
...
if __name__ == "__main__":
    ...
    NUM_PIXELS = 6
    pixels = NeoPixelBackground(NEOPIXEL, NUM_PIXELS,bpp=4,pixel_order="GRBW")
   # while True:
 
    pixels.fill((255,0,128,0))
    time.sleep(1)
